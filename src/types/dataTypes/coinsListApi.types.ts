...
export const CoinsListResponseSchema = z.array(
	z.object({
		...
		price1HrAgo: z.number().describe('The price of the coin 1 hour ago'),
		price4HrAgo: z.number().describe('The price of the coin 4 hours ago'),
		price1DAgo: z.number().describe('The price of the coin 1 day ago'),
		...
		totalLiquidityUsd: z
			.number()
			.describe('The total liquidity of the coin'),
		...
		percentagePriceChange1d: z
			.number()
			.describe(
				'The percentage price change of the coin in the last 1 day',
			),
		coinDevHoldings: z
			.number()
		...
		uniqueTraders1d: z
			.number()
			.describe(
				'The number of unique traders of the coin in the last 1 day',
			),
		priceLineSeries: z.array(
			z.object({
				...
				value: z
					.number()
					.describe('The price of the coin at that time'),
			}),
		),
